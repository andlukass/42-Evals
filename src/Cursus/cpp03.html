		...
		<div class="row mt-4">
			<div class="scale-section-infos col-sm-12 scale-div">
				<h3 class="font-weight-bold text-uppercase text-center mt-4 pt-4">
					...
					<a target="_blank" href="https://projects.intra.42.fr/projects/cpp-module-03">CPP Module 03</a>
				</h3>
				...
				<div class="scale-section-answers col-sm-12 scale-div">
					...
					<section class="scale-section-item dancer from-down" id="section-69376">
						<div class="section-header">
							...
							<p class="font-italic">As usual, there should be enough tests to prove that the program
								works as
						...
						<section class="scale-section-item dancer from-down" id="section-69376">
							...
							<h4 class="scale-question-name">Class and Attributes</h4>
							<p>There is a ScavTrap class. ScavTrap publicly inherits from the Claptrap class. It does
								not redeclare
								the attributes. The attributes of the ClapTrap class are now protected instead of
								private. The
							...
							<p>The messages from the constructor, destructor, and attack() function must be different
								from those of
								the ClapTrap.</p>
							<div class="scale-question-answers">
								<div class="form-group hidden scale_team_answer_id">
							...
							<p>ScavTrap must have a constructor and destructor with specific messages. Their proper
								implementation
								must be demonstrated by a sequence of calls in the expected order: if you create a
								ScavTrap, the message
								from the ClapTrap constructor should be displayed first, followed by that of the
								ScavTrap. Conversely,
								if you delete a ScavTrap, the message from the ScavTrap destructor should be displayed
								first, followed
							...
							<p>ScavTrap has a guardGate() function that displays a message on the standard output.
								ScavTrap also has
								an attack() function that displays a message different from that of the ClapTrap on the
								standard output.
							</p>
							<div class="scale-question-answers">
								<div class="form-group hidden scale_team_answer_id">
						...
						<section class="scale-section-item dancer from-down" id="section-69376">
							...
							<h4 class="scale-question-name">Class and Attributes</h4>
							<p>There is a FragTrap class that publicly inherits from ClapTrap. Attributes should not be
								redeclared
								without reason.</p>
							<div class="scale-question-answers">
								<div class="form-group hidden scale_team_answer_id">
							...
							<h4 class="scale-question-name">Construction and Destruction</h4>
							<p>FragTrap must have a constructor and destructor with specific messages. Their proper
								implementation
								must be demonstrated by a sequence of calls in the expected order: if you create a
								FragTrap, the message
								from the ClapTrap constructor should be displayed first, followed by that of the
								FragTrap. Conversely,
								if you delete a FragTrap, the message from the FragTrap destructor should be displayed
								first, followed
								by that of the ClapTrap.</p>
							<div class="scale-question-answers">
								<div class="form-group hidden scale_team_answer_id">
							...
							<h4 class="scale-question-name">Special Feature</h4>
							<p>FragTrap has a highFivesGuys() function that displays a message on the standard output.
							</p>
							<div class="scale-question-answers">
								<div class="form-group hidden scale_team_answer_id">
									<div class="col-sm-10"></div>
						...
						<section class="scale-section-item dancer from-down" id="section-69376">
							...
							<p>There is a DiamondTrap class. It inherits from both FragTrap and ScavTrap. It defines
								attributes with
								the requested values. It uses virtual inheritance to avoid the pitfalls of diamond
								inheritance.</p>
							<div class="scale-question-answers">
								<div class="form-group hidden scale_team_answer_id">
									<div class="col-sm-10"></div>
							...
							<p>The DiamondTrap class uses the attack() function of Scavtrap. It has the special
								functions of both its
								parents. DiamondTrap has a private member std::string name. The whoAmI() function has
								access to both
