		...
		<div class="row mt-4">
			<div class="scale-section-infos col-sm-12 scale-div">
				<h3 class="font-weight-bold text-uppercase text-center mt-4 pt-4">
					...
					<a target="_blank" href="https://projects.intra.42.fr/projects/minirt">minirt</a>
				</h3>
				...
				<div class="scale-section-answers col-sm-12 scale-div">
					<section class="scale-section-item dancer from-down" id="section-70025">
						<div class="section-header">
							...
							<p>Check that the project compiles well (without re-link) when you excute the `make` command
								and that the
								executable
								name is `miniRT`.</p>
							...
							<p>- Hide either part of the window or the whole window with another window
								or the screen's borders, minimize the minirt window to the dock/taskbar and maximize it
								back.
					...
					<section class="scale-section-item dancer from-down" id="section-70028">
						<div class="section-header">
							...
							<p class="font-italic">We will look at your bonuses if and only if your mandatory part is
								excellent. This
								means that your must complete the
								mandatory part, beginning to end, and your error management must be flawless, even in
								cases of twisted
								or bad
								usage. So if the mandatory part didn't score all the point during this defence bonuses
								will be totally
								ignored.
							</p>
						</div>
