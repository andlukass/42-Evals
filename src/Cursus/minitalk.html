		...
		<div class="row mt-4">
			<div class="scale-section-infos col-sm-12 scale-div">
				<h3 class="font-weight-bold text-uppercase text-center mt-4 pt-4">
					...
					<a target="_blank" href="https://projects.intra.42.fr/projects/minitalk">minitalk</a>
				</h3>
				...
				<div class="p-0 scale-guidelines dancer from-down" id="guidelines-24640">
					...
					<p>
						...
						that no
						malicious aliases were used to fool you and make you <br> evaluate something that is not the
						content of the
						...
						completed the
						assignment you are going to evaluate, you have <br> to read the entire subject before starting
						the
						...
						<br> strongly
						encouraged to review together the work that was turned in, <br> to identify any mistakes that
						shouldn't be
				...
				<div class="scale-section-answers col-sm-12 scale-div">
					...
					<section class="scale-section-item dancer from-down" id="section-69336">
						<div class="section-header">
							...
							<p class="font-italic">This project is an introduction to signals. Check the code and ensure
								the
