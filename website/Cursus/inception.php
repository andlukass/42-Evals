		...
		<div class="row mt-4">
			<div class="scale-section-infos col-sm-12 scale-div">
				<h3 class="font-weight-bold text-uppercase text-center mt-4 pt-4">
					...
					<a target="_blank" href="https://projects.intra.42.fr/projects/inception">Inception</a>
				</h3>
				...
				<div class="p-0 scale-guidelines dancer from-down" id="guidelines-30064">
					...
					<p>
						...
						identify any mistakes that shouldn't be repeated in the future.<br>
					</p>
				</div>

				<hr>
				<div class="dancer from-down" id="attachments-30064">
			...
			<form class="simple_form form-horizontal" novalidate="novalidate" id="edit_scale_team_6211442"
				action="https://projects.intra.42.fr/projects/inception/project_sessions/5815/evaluations/3607/scales/30064/scale_teams/6211442"
				accept-charset="UTF-8" method="post">
				<div class="scale-section-answers col-sm-12 scale-div">
					<section class="scale-section-item dancer from-down" id="section-83093">
						<div class="section-header">
							...
							<p class="font-italic">If cheating is suspected, the evaluation stops here. Use the "Cheat"
								flag to report it. Take this decision calmly, wisely, and please, use this button with
								caution.</p>
						</div>
					...
					<section class="scale-section-item dancer from-down" id="section-83094">
						<div class="section-header">
							<hr>
						...
						<ul>
							...
							<li>Examine the Dockerfiles. The containers must be built either from the
								penultimate stable version of Alpine or Debian.</li>
					...
					<section class="scale-section-item dancer from-down" id="section-83095">
						<div class="section-header">
							<hr>
					...
					<section class="scale-section-item dancer from-down" id="section-83096">
						<div class="section-header">
							<hr>
				...
				<div class="col-sm-12 scale-div pb-4">
					<div class="dancer from-down" id="ratings-30064">
