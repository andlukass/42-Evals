		...
		<div class="row mt-4">
			<div class="scale-section-infos col-sm-12 scale-div">
				<h3 class="font-weight-bold text-uppercase text-center mt-4 pt-4">
					...
					<a target="_blank" href="https://projects.intra.42.fr/projects/ft_irc">ft_irc</a>
				</h3>
				...
				<div class="scale-section-answers col-sm-12 scale-div">
					<section class="scale-section-item dancer from-down" id="section-69421">
						...
						<ul>
							...
							<li>Verify that private messages (PRIVMSG) are fully functional with different parameters.
							</li>
						</ul>
						...
						<ul>
							<li>With both nc and the reference IRC client, check that a regular user
								...
								operator. All the channel operation commands should be tested (remove one point for each
								feature
								that is
								not working).</li>
						</ul>
