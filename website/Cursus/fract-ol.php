		...
		<div class="row mt-4">
			<div class="scale-section-infos col-sm-12 scale-div">
				<h3 class="font-weight-bold text-uppercase text-center mt-4 pt-4">
					...
					<a target="_blank" href="https://projects.intra.42.fr/projects/42cursus-fract-ol">fract-ol</a>
				</h3>
				...
				<div class="p-0 scale-guidelines dancer from-down" id="guidelines-24644">
					...
					<p>
						...
						mistakes that
						shouldn't be repeated in the future.<br><br>- You must also verify the absence of memory leaks.
						Any memory
						allocated on <br> the heap must be properly freed before the end of execution. <br> You are
						allowed to use
						any of the different tools available on the computer, <br> such as leaks, valgrind, or e_fence.
						In case of
					...
					<div class="project-attachments-list">
						...
						<div class="project-attachment-item">
							<h4 class="attachment-name">
								<span class="icon-file"></span>
								<a target="_blank"
									href="https://github.com/rphlr/42-Subjects/">minilibx_mms_beta.tgz</a>
							</h4>
						</div>
						<div class="project-attachment-item">
							<h4 class="attachment-name">
				...
				<div class="scale-section-answers col-sm-12 scale-div">
					<section class="scale-section-item dancer from-down" id="section-69347">
						<div class="section-header">
							...
							<p class="font-italic">Search for Julia and Mandelbrot sets on Wikipedia, or watch the
								e-learning
