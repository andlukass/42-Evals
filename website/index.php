		...
		<div class="row mt-4">
			<div class="scale-section-infos col-sm-12 scale-div">
				...
				<div class="dancer from-down" id="funny-stats">
					...
					<center>
						<b>Last stargazer:</b>
						<p><!--last_stargazer_start_HTML--><a href="https://github.com/abberant"><img
                  src="https://avatars.githubusercontent.com/u/109932381?v=4&s=250"
                  target="_blank"></a><!--last_stargazer_end_HTML-->
						</p>
						<p>Thanks to <!--name_start_HTML--><a href="https://github.com/abberant">abberant</a><!--name_end_HTML-->
							for starring the repository! 🎉</p>
					</center>
					<b>Star Count: <a href="https://github.com/rphlr/42-Evals"
							target="_blank"><!--stars_start-->483<!--stars_end--></a> 🌟</b>
					<br />
					<p><b>Updates occur hourly. Last update :</b> <!--date_start_HTML-->15.01.2024, 12:14:01<!--date_end_HTML-->
						(CET)</p>
					<center>
						<div>
